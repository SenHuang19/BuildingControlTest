...
default['floor1_outdoor_damper_stuck'] = {'variable':'floor1_outdoor_damper_stuck_input'}
...
y = requests.post('{0}/advance'.format(url_eplus), data=json.dumps({'floor1_outdoor_damper_stuck_input':0.5})).json()

print(y['floor1_ahu_fre_damper_pos'])
print(y['floor1_ahu_fre_damper_pos_real'])